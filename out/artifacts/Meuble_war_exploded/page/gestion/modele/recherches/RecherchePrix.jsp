...
<section id="blog" class="blog">
    <div class="container aos-init aos-animate" data-aos="fade-up">
        <form action="RechercheModeleParPrix.SearchController" method="post">
            <div class="section-title-col-2 aos-init aos-animate" data-aos="fade-up" data-aos-delay="300">
                ...
                <h2>Recherche par totale prix des matiere</h2>
            </div>
            <div class="row">
                            ...
                            <div class="row">
                                <div class="col-lg-6 col-md-6">
                                    <div class="form-group my-2">
                                        <input type="text" name="prixMin" class="form-control" id="prixMin" placeholder="Prix minimum" required="">
                                    </div>
                                </div>
                                <div class="col-lg-6 col-md-6">
                                    <div class="form-group my-2">
                                        <input type="text" name="prixMax" class="form-control" id="prixMax" placeholder="Prix maximum" required="">
                                    </div>
                                </div>
                            </div>
            ...
            <table class="table">
                <thead>
                  <tr>
                    ...
                    <th scope="col">Total prix des matieres</th>
                  </tr>
                </thead>
                <tbody>
                    <% 
